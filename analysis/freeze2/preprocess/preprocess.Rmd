...
# https://hoffmg01.hpc.mssm.edu/nps_ad/analysis/freeze2/preprocess/preprocess_RUSH.html
...
## UMAP
```{r umap1}
plotProjection(sce, "X_umap", "class", order=ctorder)  + ggtitle("class")
```
...
```{
  r umap3}
plotProjection(sce, "X_umap", "subtype", order=ctorder)  + ggtitle("subtype")
```
