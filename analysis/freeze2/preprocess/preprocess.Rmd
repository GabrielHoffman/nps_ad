...
for(cluster_id in c("class", "subclass", "subtype") ){
  for(sample_id in c("Channel", "SubID") ){
    ...
    filePrefix = paste0("/sc/arion/projects/psychAD/NPS-AD/freeze2_rc/pseudobulk/", gsub(".h5ad$", "", basename(params$DATASET)), "_", sample_id, "_", cluster_id)
...
```{r read.pseudobulk}
filePrefix = paste0("/sc/arion/projects/psychAD/NPS-AD/freeze2_rc/pseudobulk/", gsub(".h5ad$", "", basename(params$DATASET)), "_", "Channel", "_", "subclass")
