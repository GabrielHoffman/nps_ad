...
# bsub -Is -q premium -R span[hosts=1] -R rusage[mem=30000] -W 128:00 -P acc_CommonMind -n 12 bash
...
# March 26
h5ad_files = c(
RUSH = "RUSH_2023-06-08_21_44.h5ad", 
HBCC = "HBCC_2023-06-08_21_58.h5ad",
MSSM = "MSSM_2023-06-08_22_31.h5ad",
FULL = "FULL_2023-06-08_23_53.h5ad",
AGING = "AGING_2023-06-09_01_45.h5ad")
...
for(cluster_id in cluster_id_options ){
  for(sample_id in sample_id_options ){
    ...
    if( sample_id == "Channel"){
      form = ~ (1|SubID) + (1|poolID) + Sex + scale(Age) + log(n_genes)
    }else{      
      form = ~ Sex + scale(Age) + log(n_genes)
    }
