...
Rscript -e "rmarkdown::render(\"$DIR/MAPT.Rmd\", output_file = \"$OUTFILE\", 
params=list(dataset = \"$dataset\", variable_type = \"$variable_type\", AnnoLevel = \"$AnnoLevel\", SampleLevel = \"$SampleLevel\", ctst_key = \"$ctst_key\"))"
...
df$H1H2 = factor(df$haplotype, c("H1H1", "H1H2", "H2H2"))
...
if( params$variable_type == "ORD" ){
  ...
  save(fit, coef.test, file="~/test.RDATA")
