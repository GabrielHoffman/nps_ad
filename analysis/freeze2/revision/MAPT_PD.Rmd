...
SampleLevel="SubID"
variable="H1H2"
ctst_key=${dataset}_${variable}_${SampleLevel}_${AnnoLevel}_PDinteraction
...
OUTFILE=/sc/arion/projects/psychAD/NPS-AD/freeze2_rc/analysis/results/${ctst_key}/${ctst_key}
mkdir -p $OUTFILE
echo "rmarkdown::render(\"$DIR/MAPT_PD.Rmd\", output_file = \"$OUTFILE\", 
...
# PD phenotype
PD = rep(NA, nrow(res.proc@data))
idx = (res.proc@data$c56x == "PD_crossDis") | (res.proc@data$c57x == "PD_crossDis")
PD[idx] = "PD_crossDis"
idx = (res.proc@data$c56x == "Controls_crossDis") | (res.proc@data$c57x == "Controls_crossDis")
PD[idx] = "Controls_crossDis"
PD = factor(PD, c("Controls_crossDis", "PD_crossDis"))
res.proc@data$PD = PD
# PD
# Controls_crossDis       PD_crossDis 
#               188                40 


bpparam = SnowParam(8)

form = paste0("~ H1H2*PD + PC1 + PC2 + ", paste0(covariates, collapse=" + ")) 
form = as.formula(form)
