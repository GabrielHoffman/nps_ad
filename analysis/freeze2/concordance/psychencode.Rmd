...
res = mclapply(pairValues, function(id){
  ...
  res = lapply(ids, function(id){
    file = paste0("/sc/arion/projects/CommonMind/mpjanic/PEC/final_dl/final/", id, ".csv")
  ...
  df_est = lapply(res, function(x) x$df_est) %>% bind_rows
  df_se =  lapply(res, function(x) x$df_se) %>% bind_rows
