...
formula: `r paste0(as.character(form), collapse=' '), results="asis"`

formula vp: `r paste0(as.character(form.vp), collapse=' '), results="asis"`

n samples: `r ncol(cobj), results="asis"`

n retained: `r nrow(fit$design), results="asis"`
