...
# ctst_key = "HBCC_SCZ_BD_CTRL"
# dataset = "HBCC"
outpath = paste0("/sc/arion/projects/psychAD/NPS-AD/freeze2_rc/analysis/results/", toupper(params$dataset), "_", params$ctst_key, "_", params$SampleLevel, "_", params$AnnoLevel, "/")
...
pattern = paste0(toupper(params$dataset), "_2023-04-01.*_processAssays_", params$SampleLevel, "_", params$AnnoLevel, ".RDS")
...
if( params$SampleLevel == "Channel" ){
  covariates_base = c(covariates_base, "(1|SubID)", "(1|pool)")
}
```
