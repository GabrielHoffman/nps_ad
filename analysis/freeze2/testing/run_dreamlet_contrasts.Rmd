...
# read processed data
path = paste0("/sc/arion/projects/psychAD/NPS-AD/freeze2_rc/processAssays/")
pattern = paste0(toupper(params$dataset), "_2023-09.*_processAssays_", params$SampleLevel, "_", params$AnnoLevel, ".RDS")
...
covariates_base = c("scale(Age)", "Sex", "scale(PMI)", "log(n_genes)")#, "(1|prep)") 
...
file = paste0(outpath, "/topTable_DE.tsv")
...
if( params$variable_type == "ORD" ){
  ...
  file = paste0(outpath, "/topTable_DE_joint.tsv")
