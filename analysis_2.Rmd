...
```{r dreamlet.fit}
form = ~ Sex + (1|group_id) + (1|batch) + (1|round_num) + (1|HTO) + (1|Institution) + Dx2 + scale(Age) + scale(PMI)
...
# Add dream here
# deal with NA's here 
form = ~ (1|group_id) + (1|batch) + (1|round_num) + (1|HTO) + (1|Sex) + (1|Dx2) + (1|Institution) + scale(Age) + scale(PMI)
...
form = ~ (1|group_id) + (1|batch) + (1|round_num) + (1|HTO) + (1|Sex) + (1|Institution) + Dx2 + scale(Age) + scale(PMI)
