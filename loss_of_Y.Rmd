...
chromExpr = aggregateByFeatures(sceCombine[,c(4000000:4067811)], 'X', rowData(sceCombine)[1:10,], 'gene_chrom', 'gene_id', BPPARAM=SnowParam(1, progressbar=TRUE), batchSize=100000)
...
```{r outrider}
library(OUTRIDER)
ods <- OutriderDataSet(countData=chromExpr[, -c(1:4000000)])
