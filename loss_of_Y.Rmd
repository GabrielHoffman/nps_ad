...
chromExpr = countsByChrom(sceCombine[,1:320000], 'X', df_gene, 'SYMBOL', 'ENSEMBL')
...
a = matrix(0, 200, 4000000)
idx = sample(length(a), 1e5, replace=FALSE)
a[idx] = 1
file.remove("test.h5")
writeHDF5Array(as( a, "sparseMatrix"), "test.h5")


b = HDF5Array('test.h5', "HDF5ArrayAUTO00001")
