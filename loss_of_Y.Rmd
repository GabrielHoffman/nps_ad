...
```{r plotVolcano, fig.width=5, fig.height=4}
...
```{r plotExpressionRank, fig.width=5, fig.height=4}
plotExpressionRank(ods, "Y", basePlot=TRUE) + theme_classic() + theme(aspect.ratio=1)
plotExpressionRank(ods, "1", basePlot=TRUE) + theme_classic() + theme(aspect.ratio=1)
```

```{r plotExpectedVsObservedCounts, fig.width=5, fig.height=4}
plotExpectedVsObservedCounts(ods, "Y", basePlot=TRUE) + theme_classic() + theme(aspect.ratio=1)
plotExpectedVsObservedCounts(ods, "1", basePlot=TRUE) + theme_classic() + theme(aspect.ratio=1)
```
