...
# get reads on X and Y chroms
chromExpr = aggregateByFeatures(sceCombine, 'X', df_gene$SYMBOL, df_gene$ENSEMBL)
...
fit.dl = dreamlet( res.proc, form, BPPARAM=SnowParam(12))
...
fit.for.resid = dreamlet( res.proc, form, BPPARAM=SnowParam(12))
