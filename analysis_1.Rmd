...
files = dir("/sc/arion/projects/CommonMind/hoffman/NPS-AD/work/", pattern="NPSAD_concat.*h5ad", full.names=TRUE)[1:2]
...
res.proc = processAssays( pbObj, ~ Donor + Batch, 
  min.count = 5, 
...
<!---
Fix so that subsetting pbObj doesnt fail
...
```{r varPart}
res.vp = fitVarPart(res.proc, ~ Donor + Batch, BPPARAM = SnowParam(1, progressbar=TRUE))
```
