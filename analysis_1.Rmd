...
sceList_filter = mclapply(sceList[1:200], function(sce){
...
sceCombine = do.call(cbind, sceList_filter)
```
...
ggplot(df, aes(UMAP1, UMAP2, color=anno)) + geom_point(size=0.1) + theme_classic() + theme(aspect.ratio=1)
```
