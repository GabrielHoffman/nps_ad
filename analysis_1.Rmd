...
ggplot(df, aes(UMAP1, UMAP2, color=leiden_labels)) + geom_point(size=.05) + theme_classic() + theme(aspect.ratio=1) + guides(colour = guide_legend(override.aes = list(size = 1.5)))
```
...
```{r vp.examine2, fig.height=6, fig.width=8, cache=FALSE}      
