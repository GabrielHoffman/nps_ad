...
ods = controlForConfounders(ods, q=10, BPPARAM=SnowParam(12, progressbar=TRUE))
# ods <- findEncodingDim(ods, BPPARAM=SnowParam(1, progressbar=TRUE))
...
ods_male = controlForConfounders(ods_male, q=10, BPPARAM=SnowParam(12, progressbar=TRUE))
# ods_male <- findEncodingDim(ods_male, BPPARAM=SnowParam(1, progressbar=TRUE))
# visualize the hyper parameter optimization
# plotEncDimSearch(ods_male)
...
ods_female = controlForConfounders(ods_female, q=10, BPPARAM=SnowParam(12, progressbar=TRUE))
# ods_female <- findEncodingDim(ods_female, BPPARAM=SnowParam(12, progressbar=TRUE))
# visualize the hyper parameter optimization
# plotEncDimSearch(ods_female)
...
```{r plotQQ, fig.width=10, fig.height=35, dev="png"}
