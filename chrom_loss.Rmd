...
ods = controlForConfounders(ods, q=2, BPPARAM=SnowParam(12, progressbar=TRUE))
...
ods_male = controlForConfounders(ods_male, q=2, BPPARAM=SnowParam(12, progressbar=TRUE))
...
ods_female = controlForConfounders(ods_female, q=2, BPPARAM=SnowParam(12, progressbar=TRUE))
