...
path = '/sc/arion/projects/CommonMind/hoffman/NPS-AD/work/'
rmarkdown::render('chrom_loss.Rmd', intermediates_dir=path, output_dir=path);
...
saveRDS(res_combine, file="/hpc/users/hoffmg01/work/nps_ad/outliers.RDS")
```
...
```{r rm}
rm("res_combine", "chromExpr", "sceCombine")
gc()
```
