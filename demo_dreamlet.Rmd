...
fig = ggplot(resTab, aes(assay.x, estimate, fill=assay.x)) + geom_bar(stat="identity") + theme_classic() + theme(aspect.ratio=1, legend.position="none") + facet_wrap(~coef) + coord_flip()
