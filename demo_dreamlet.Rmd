...
```{r collapse}
pbList.Donor = list(  A = pbObj.Donor[,pbObj.Donor$round_num %in% 1:2],
                      B = pbObj.Donor[,pbObj.Donor$round_num %in% 3:4])
