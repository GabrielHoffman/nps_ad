...
idx = !is.na(pb.subtype$Dx)

vp.c = fitExtractVarPartModel(cobj[,idx], form, colData(pb.subclass)[idx,])
...
vp.c = fitExtractVarPartModel(cobj[,idx], form, colData(pb.subtype)[idx,])
