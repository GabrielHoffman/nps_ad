...
```{r load.data}
file = "/sc/arion/projects/psychAD/NPS-AD/public_release_0/Rush_Dec_19_2022.h5ad"
...
# Subclass
```{r cca}
form = ~ SubID + poolID + Sex + scale(Age) + AD + PMI
...
form = ~ (1|SubID) + (1|poolID) + (1|Sex) + scale(Age) + (1|AD) + PMI
...
# analysis with dream()
form = ~ (1|SubID) + (1|poolID) + (1|Sex) + scale(Age) + AD + PMI
