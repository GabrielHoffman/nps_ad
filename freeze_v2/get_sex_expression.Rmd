...
# res = kmeans(df_sex[,c("XIST", "UTY")], centers=df_known[,c("XIST", "UTY")])
...
col = df_known$id[fit$classification]
...
sce = readH5AD(file, use_hdf5=TRUE, verbose=TRUE, layers=FALSE)   
...
h5ls /sc/arion/projects/CommonMind/leed62/PEC/h5ad/Finalized_h5ad/CMC_annotated.h5ad/layers/raw_new
