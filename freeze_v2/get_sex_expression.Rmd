...
df = data.frame(t(assay(sce, "X")[genes,]))

with(df, plot(log2(ENSG00000183878_index+0.1), log2(ENSG00000229807_index+0.1)))
...
df = data.frame(t(logcounts(sce)[genes,]))
colnames(df)[colnames(df)=='ENSG00000183878_index'] = "XIST"
colnames(df)[colnames(df)=='ENSG00000229807_index'] = "UTY"

genes = c('ENSG00000183878')
df = data.frame(t(logcounts(sce)[genes,]))
colnames(df)[colnames(df)=='ENSG00000183878'] = "XIST"
colnames(df)[colnames(df)=='ENSG00000229807'] = "UTY"



with(df, plot(XIST, UTY))
...
ggplot(df, aes(XIST, UTY, color=fit$z[,1])) + 
    geom_point() + 
    theme_classic() + 
