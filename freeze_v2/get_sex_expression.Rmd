...
# Logistic classifier
GLM uses formula `Sex ~ XIST + UTY + XIST:UTY` at the single cell level using sex from metadata.  Also shows variance partitioning
