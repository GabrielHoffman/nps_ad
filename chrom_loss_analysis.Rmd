...
outfile = "/sc/arion/projects/CommonMind/hoffman/NPS-AD/work/nps_ad/sce_mosaic_aneuploidy_AD.tsv"
...
```{r across.chrom, eval=FALSE}


idx = with(df_res, (dx %in% c("AD", "Control")))
data = droplevels(df_res[idx,])
data$dx = factor(data$dx, c("Control", "AD"))

data$zScore.loss = -pmin(data$zScore, 0)
data$zScore.gain = pmax(data$zScore, 0)
