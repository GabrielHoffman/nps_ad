...
ggplot(res_lmz[res_lmz$coef=="dxAD",], aes(geneID, celltype, fill=t.value)) + geom_tile() + theme_classic() + theme(aspect.ratio=ratio, plot.title = element_text(hjust = 0.5)) + scale_fill_gradient2(low = "blue", mid="white", high="red") + facet_wrap(~ Direction, ncol=1) + ggtitle("dxAd")

ggplot(res_lmz[res_lmz$coef=="scale(Age)",], aes(geneID, celltype, fill=t.value)) + geom_tile() + theme_classic() + theme(aspect.ratio=ratio, plot.title = element_text(hjust = 0.5)) + scale_fill_gradient2(low = "blue", mid="white", high="red") + facet_wrap(~ Direction, ncol=1) + ggtitle("Age")
```
