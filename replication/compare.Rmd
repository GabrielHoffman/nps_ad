...
scp minerva:"/sc/arion/projects/CommonMind/hoffman/NPS-AD/work/nps_ad/replication/*class.tsv" /Users/gabrielhoffman/Library/CloudStorage/Dropbox/projects/psychAD/DE\ signatures/
...
## PsychAD m21x vs Mathys CERAD
```{r m21x_mathys_braaksc_class}
df1 = res.pad %>%
...
```{r m21x_mathys_braaksc_subclass}
df1 = res.pad %>%
