...
file = "/sc/arion/projects/psychAD/NPS-AD/freeze2_rc/analysis/results/meta/topTable_meta_m01x_FE.parquet"
res.pad = read_parquet(file) %>%
...
plotTiles = function(df1, df2, xlab, ylab){
  ...
  df %>%
    ...
    ggplot(aes(CT1, CT2, fill=pmax(rho, 0))) +
      ...
      theme_classic() +
      coord_equal() +
      scale_fill_gradient2(low="blue2", mid="white", high="red2", limits=c(0, .6)) +
      xlab(xlab) +
      ylab(ylab)
}
