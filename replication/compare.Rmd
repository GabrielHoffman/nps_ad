...
scp minerva:"/sc/arion/projects/CommonMind/hoffman/NPS-AD/work/nps_ad/replication/compare_files/figure-html/*pdf" /Users/gabrielhoffman/Library/CloudStorage/Dropbox/projects/psychAD/DE\ signatures/
...
res$fig
plotConcordanceRank( res$tab, ylab)
write_tsv(res$tab, file="m17x_mathys_braaksc_class.tsv")
```
...
res$fig
plotConcordanceRank( res$tab, ylab)
write_tsv(res$tab, file="m19x_mathys_braaksc_class.tsv")
```
...
res$fig
plotConcordanceRank( res$tab, ylab)
write_tsv(res$tab, file="m17x_mathys_braaksc_subclass.tsv")
```
