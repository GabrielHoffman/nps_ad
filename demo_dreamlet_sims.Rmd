...
run_analysis = function(n_batches, methods){
  ...
  resTabl = mclapply(n_batches, function(nbatch){
    ...
    resTabl = lapply(methods, function(method){
      ...
      res1 = run_method( pbObj.Donor[1:500,idx], ~ Dxsim + cohort, method)
      res2 = run_method( pbObj.Donor[1:500,idx], ~ Dxsim + cohort + BatchID, method)
      # if( method == "dreamlet"){      
...
# methods = c('dreamlet', "DESeq2", "limma-voom", "edgeR")
